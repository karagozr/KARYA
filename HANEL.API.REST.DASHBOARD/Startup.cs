...
using HANEL.API.REST.DASHBOARD.Middlewares;
...
namespace HANEL.API.REST.DASHBOARD
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddERPDashboardService();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "HANEL.API.REST.DASHBOARD", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "HANEL.API.REST.DASHBOARD v1"));
            }
            ...
            app.UseEndpoints(endpoints => {
                EndpointRouteBuilderExtension.MapDashboardRoute(endpoints, "", "DefaultDashboard");
