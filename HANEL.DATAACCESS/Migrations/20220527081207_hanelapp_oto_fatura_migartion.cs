...
{
    public partial class hanelapp_oto_fatura_migartion : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsletmeKodu = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SubeKodu = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AlanVkn = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OtoFatura", x => x.Id);
                });
        }
