...
namespace HANEL.WEB.REPORT {
    public class DataBaseEditaleDashboardStorage : DashboardFileStorage , IEditableDashboardStorage {
        ...
        public void DeleteDashboard(string dashboardID)
        {
            ...
            {
                connection.Open();
                SqlCommand GetCommand = new SqlCommand("delete FROM Dashboards WHERE ID=@ID");
